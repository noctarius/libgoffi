...
image:https://coveralls.io/repos/github/clevabit/libgoffi/badge.svg?branch=master[https://coveralls.io/github/clevabit/libgoffi?branch=master, window="_blank"]
